...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.75\textwidth]{hsv_comparison.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.75\textwidth]{ycbcr_comparison.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.4\textwidth]{facelandmark_example.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.48\textwidth]{mediapipe_facelandmark_orientatitionpoints.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{facelandmark_eyes.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{eyelandmarks.png}
